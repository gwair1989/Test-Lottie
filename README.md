...
Add A/B Firebase test
Test hypothesis:
By minimising distractions in the order wall, the hypothesis is that more users will continue in the order flow by entering a menu list.
The goal of the experiment is to have more users entering a menu list from the order wall. Use the firebase event view_item_list when setting up the experiment objective.
